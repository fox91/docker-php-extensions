...
.PHONY: 7.3
7.3: 7.3-buster 7.3-bullseye 7.3-alpine3.14

.PHONY: 7.4
7.4: 7.4-buster 7.4-bullseye 7.4-alpine3.14

.PHONY: 8.0
8.0: 8.0-buster 8.0-bullseye 8.0-alpine3.14
...
.PHONY: clean
clean: 7.3-buster-clean 7.3-bullseye-clean 7.3-alpine3.14-clean 7.4-buster-clean 7.4-bullseye-clean 7.4-alpine3.14-clean 8.0-buster-clean 8.0-bullseye-clean 8.0-alpine3.14-clean cleanup

.PHONY: cleanup
cleanup:
	set -eu; \
	for os_v in 'buster' 'bullseye' 'alpine3.14'; do \
