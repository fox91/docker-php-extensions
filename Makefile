...
.PHONY: alpine3.12
alpine3.12: 7.2-alpine3.12 7.3-alpine3.12 7.4-alpine3.12

.PHONY: clean
clean: 7.2-buster-clean 7.2-alpine3.12-clean 7.3-buster-clean 7.3-alpine3.12-clean 7.4-buster-clean 7.4-alpine3.12-clean cleanup
